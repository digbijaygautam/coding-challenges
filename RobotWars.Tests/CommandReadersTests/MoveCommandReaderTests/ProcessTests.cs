...
namespace RobotWars.Tests.CommandReadersTests.MoveCommandReaderTests
{
    ...
    public class ProcessTests
    {
        ...
        private Mock<IList<ICommand>> commands;
        [SetUp]
        public void Setup()
        {
            this.context = new Mock<IContext>();
            this.robot = new Mock<IRobot>();
            this.commands = new Mock<IList<ICommand>>();
            this.context.SetupGet(c => c.LatestRobot).Returns(this.robot.Object);
            this.logger = new Mock<ILogger>();
            this.moveCommandReader = new MoveRobotCommandReader(this.context.Object,this.commands.Object,this.logger.Object);
        }
